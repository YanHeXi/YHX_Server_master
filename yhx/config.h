...
namespace yhx
{
    ...
    public:
        ...
        std::string toString() override
        {
            ...
            {
                YHX_LOG_ERROR(YHX_LOG_ROOT()) << "ConfigVar::toString exception "
        ...
        bool fromString(const std::string &val) override
        {
            ...
            {
                YHX_LOG_ERROR(YHX_LOG_ROOT()) << "ConfigVar::fromString exception "
    ...
    public:
                                                 ...
                                                 const std::string &description = "")
        {
            ...
            {
                YHX_LOG_ERROR(YHX_LOG_ROOT()) << "Lookup name invalid " << name;
